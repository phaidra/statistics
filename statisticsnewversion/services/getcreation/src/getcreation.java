 ...
 */
@ExposeToClient
public class getcreation  extends JavaServiceSuperClass {
/* Pass in one of FATAL, ERROR, WARN,  INFO and DEBUG to modify your log level;
   ...
   int myinstance, String myredcode, String myyear, String myaccesscode, String mystate) throws SQLException {
 String mypid="";
 String mytype="";
        String result = null;
        int lport = 5656;
...
/*
          ...
          //  session.connect();
            ...
            conn = DriverManager.getConnection(url, dbuserName, dbpassword);
              System.out.println("getcreation #############################d");
            System.out.println("Database getcreation established");
...
String sql= "select concat(month(a.created),'-',year(a.created) ) as monthis, created as dateis, count(oid) as count, owner as owner"+
" from inventory as a " +
...
myinstanceis+
myredcodesql+
" group by concat(month(a.created),'-',year(a.created) ) order by 2;";

 ...
 */
@ExposeToClient
public class getinstances extends JavaServiceSuperClass {
...
/*
          ...
          //  session.connect();
            ...
            String sql = "SELECT distinct idsite from inventory;";
            ...
            while (rs2.next()) {
                ...
                int myidsite = rs2.getInt("idsite");
               String myitem = "{instance:'" + myidsite+  "'},";
                //  "{datevisit:'"+datevisit+"'},";

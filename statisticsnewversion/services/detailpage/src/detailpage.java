 ...
 */
@ExposeToClient
public class detailpage extends JavaServiceSuperClass {
/* Pass in one of FATAL, ERROR, WARN,  INFO and DEBUG to modify your log level;
    ...
    String myyear,int myinstance) throws SQLException {
...
/*
          ...
          //  session.connect();
            ...
            System.out.println("detailpage #############################d");
            System.out.println("Database detailpage established");
...
String mynegative="and b.oid not in (select  a.custom_var_v4 " + " from piwik_log_link_visit_action as a  " + 
            " ,inventory as b " + " where " + " b.oid=a.custom_var_v4 " +
...
"  and b.cmodel!='Page' "+
            ...
            myredcodesql +myinstanceis+
            //" group by v1 order by concat(month(a.server_time),'-',year(a.server_time) ) desc  ;";
            " group by custom_var_v4   )";
            ...
            sql = "select b.cmodel, b.owner as owner, count(month(a.server_time)) as howmany, "+
            " concat(month(a.server_time),'-',year(a.server_time) )  " + " as monthofvisit , a.custom_var_v1 as v1 ," +
            " a.custom_var_k1 as k1,a.custom_var_v2 as v2,a.custom_var_k2 as k2," + " a.custom_var_v3 as v3,a.custom_var_k3 as k3,"
            +" a.custom_var_v4 as v4,a.custom_var_k4 as k4, " + " a.custom_var_v5 as v5,a.custom_var_k5 as k5 , "+
          " a.server_time as datevisit  " + " from piwik_log_link_visit_action as a  " + 
            " ,inventory as b " + " where " + " b.oid=a.custom_var_v4 " +
            //" and a.custom_var_v1 is not null "+ 
            " and b.cmodel like '%" + mycmodel + "'" + " and b.acccode like '%" + myaccesscode +
            "' and ( lower(a.custom_var_k4) = 'detail page'  )  " +
...
"  and b.cmodel!='Page' "+
            ...
            myredcodesql +myinstanceis+
            //" group by v1 order by concat(month(a.server_time),'-',year(a.server_time) ) desc  ;";
            " group by v4 order by howmany desc  ;";

 ...
 */
@ExposeToClient
public class getcreationday  extends JavaServiceSuperClass {
/* Pass in one of FATAL, ERROR, WARN,  INFO and DEBUG to modify your log level;
     *  recommend changing this to FATAL or ERROR before deploying.  For info on these levels, look for tomcat/log4j documentation
     */
    public getcreationday() {
        super(INFO);
    }
    ...
    public String main( String mypidin,String myownerin, String myredcode, String mycontentmodel,
   int myinstance, String myday, String mymonth, String myyear, String myaccesscode, String mystate) throws SQLException {
 String mypid="";
 String mytype="";
        String result = null;
        int lport = 5656;
...
/*
          ...
          //  session.connect();
            ...
            conn = DriverManager.getConnection(url, dbuserName, dbpassword);
              System.out.println("getcreateionday #############################d");
            System.out.println("Database getcreateionday established");
...
//String sql= "select concat(day(a.created),'-',month(a.created),'-',year(a.created) ) as monthis, "+
String sql= "select hour(a.created)  as monthis, "+
" a.oid as oid, created as dateis, count(oid) as count1, owner as owner, cmodel as cmodel"+
" from inventory as a " +
" where acccode like '%"+myaccesscode+"' "+
" and cmodel like '%"+mycontentmodel+"' "+
" and oid like '%"+mypidin+"%' "+
" and owner like '%"+myownerin+"%' "+
" and cmodel!='Page' "+
mystatesql+
myyearsql+
myinstanceis+
myredcodesql+
mymonthsql+
" and day(a.created)="+myday+
//" group by concat(day(a.created),'-',month(a.created),'-',year(a.created) ) "+
" group by 2 "+
" order by 2 ; ";
            ...
            while (rs.next()) {
               ...
               //  int count = rs.getInt("count");
                String monthis = rs.getString("monthis");
                 String mycmodel = rs.getString("cmodel");
                String myoid=rs.getString("oid");
                String myowner=rs.getString("owner");
                
               
               String myitemx = "{oid:'" + myoid + 
               "',cmodel:'" + mycmodel +
                "',owner:'" + myowner +
               "',monthis:'" + monthis +
               "'},";
